...
class Ui_Sales_Menu(object):
    def setupUi(self, Sales_Menu):
        if not Sales_Menu.objectName():
            Sales_Menu.setObjectName(u"Sales_Menu")
        ...
        self.centralwidget = QWidget(Sales_Menu)
...
"background-color: white; /* Fallback color */")
        ...
        self.statusbar = QStatusBar(Sales_Menu)
        self.statusbar.setObjectName(u"statusbar")
        Sales_Menu.setStatusBar(self.statusbar)

        self.retranslateUi(Sales_Menu)

        QMetaObject.connectSlotsByName(Sales_Menu)
    # setupUi
