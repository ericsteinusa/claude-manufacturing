...
TICKETS = [
    ...
    ("TKT-002", "James Wu", "Production", "Hardware", "critical", "in_progress",
     -1, 1, "Sara Patel", "CNC machine workstation won't power on after storm outage"),
    ("TKT-003", "Anna Kowalski", "HR", "Account", "medium", "open",
     -3, 5, "", "New hire needs domain account and email setup"),
    ...
    ("TKT-009", "Susan Park", "Legal", "Access / Permissions", "medium", "in_progress",
     -3, 2, "Sara Patel", "Cannot access contract management folder on share drive"),
...
ASSETS = [
    ...
    ("ASSET-001", "Desktop", "Dell", "OptiPlex 7090", "DL7090-001",
     "Linda Carter", "Accounting", -730, 3, "active"),
    ("ASSET-002", "Laptop", "HP", "EliteBook 840", "HP840-002",
     "James Wu", "Production", -365, 3, "active"),
    ("ASSET-003", "Laptop", "Lenovo", "ThinkPad T14", "LN14-003",
     "Priya Sharma", "Engineering", -180, 3, "active"),
    ("ASSET-004", "Server", "Dell", "PowerEdge R750", "DPE750-004",
     "", "IT", -900, 5, "active"),
    ("ASSET-005", "Printer", "HP", "LaserJet Pro M428", "HPLJ-005",
     "", "Production", -400, 2, "repair"),
    ("ASSET-006", "Desktop", "HP", "EliteDesk 800", "HPED-006",
     "Bob Nguyen", "Sales", -500, 3, "active"),
    ("ASSET-007", "Monitor", "Dell", "UltraSharp U2722", "DU2722-007",
     "Anna Kowalski", "HR", -200, 3, "active"),
    ("ASSET-008", "Switch", "Cisco", "Catalyst 2960-X", "CS2960-008",
     "", "IT", -1100, 5, "active"),
    ("ASSET-009", "Laptop", "Apple", "MacBook Pro 14", "MBPRO-009",
     "Rachel Green", "Cust Svc", -90, 3, "active"),
    ("ASSET-010", "Desktop", "Dell", "OptiPlex 5090", "DL5090-010",
     "Carlos Ruiz", "Production", -800, 3, "active"),
    ("ASSET-011", "UPS", "APC", "Smart-UPS 1500", "APC1500-011",
     "", "IT", -600, 3, "active"),
    ("ASSET-012", "Laptop", "Dell", "Latitude 5530", "DL5530-012",
     "Susan Park", "Legal", -120, 3, "active"),
    ("ASSET-013", "Phone", "Cisco", "IP Phone 8841", "CIPH-013",
     "David Kim", "Finance", -400, 3, "active"),
    ("ASSET-014", "Desktop", "HP", "EliteDesk 705", "HPED-014",
     "", "Warehouse", -1200, 3, "retired"),
    ("ASSET-015", "Server", "HP", "ProLiant DL380", "HPDL-015",
     "", "IT", -500, 5, "active"),
]
...
REPAIRS = [
    ...
    ("ASSET-005", "Paper feed jam and roller worn out",
     "Bob Nguyen", -5, "Mike Torres", "medium", "in_progress"),
    ("ASSET-010", "Overheating — fan replaced, thermal paste",
     "Carlos Ruiz", -12, "Sara Patel", "high", "completed"),
    ("ASSET-002", "Cracked screen after drop, needs replacement",
     "James Wu", -2, "Mike Torres", "high", "open"),
    ("ASSET-014", "PSU failure on retired unit — for parts",
     "IT Dept", -30, "Sara Patel", "low", "cancelled"),
]
...
LICENSES = [
    ...
    ("Microsoft 365 Business", "Microsoft", "MS365-XXXX-YYYY",
     "subscription", 50, 38, -365, 365, 12000.00, "active"),
    ("Adobe Creative Cloud", "Adobe", "ACC-XXXX-YYYY",
     "subscription", 5, 3, -180, 180, 3000.00, "active"),
    ("AutoCAD LT 2024", "Autodesk", "ACAD-XXXX-YYYY",
     "subscription", 3, 2, -90, 275, 2400.00, "active"),
    ("SOLIDWORKS Standard", "Dassault", "SW-XXXX-YYYY",
     "perpetual", 2, 2, -730, 99999, 8000.00, "active"),
    ("Salesforce Starter", "Salesforce", "SF-XXXX-YYYY",
     "subscription", 10, 6, -60, 305, 6000.00, "active"),
    ("Zoom Business", "Zoom", "ZOOM-XXXX-YYYY",
     "subscription", 25, 18, -89, 276, 4500.00, "active"),
    ("DocuSign Business Pro", "DocuSign", "DS-XXXX-YYYY",
     "subscription", 5, 2, -30, 335, 1500.00, "active"),
    ("Antivirus Enterprise", "Bitdefender", "BD-XXXX-YYYY",
     "subscription", 60, 55, -365, 0, 1800.00, "expired"),
    ("Old MES License", "Legacy Corp", "MES-XXXX-YYYY",
     "perpetual", 5, 1, -1095, 99999, 15000.00, "active"),
]
...
NETWORK_DEVICES = [
    ...
    ("core-sw-01", "10.0.0.1", "00:1A:2B:3C:4D:01",
     "Switch", "Cisco", "Catalyst 2960-X", "Server Room", "online", 0),
    ("core-sw-02", "10.0.0.2", "00:1A:2B:3C:4D:02",
     "Switch", "Cisco", "Catalyst 2960-X", "Server Room", "online", 0),
    ("fw-01", "10.0.0.254", "00:1A:2B:3C:4D:FE",
     "Firewall", "Fortinet", "FortiGate 200F", "Server Room", "online", 0),
    ("ap-floor1-01", "10.0.1.10", "00:1A:2B:3C:4D:10",
     "Access Point", "Ubiquiti", "UniFi AP-AC-Pro", "Floor 1", "online", 0),
    ("ap-floor2-01", "10.0.2.10", "00:1A:2B:3C:4D:20",
     "Access Point", "Ubiquiti", "UniFi AP-AC-Pro", "Floor 2", "online", -1),
    ("nas-01", "10.0.0.10", "00:1A:2B:3C:4D:0A",
     "NAS", "Synology", "DS1821+", "Server Room", "online", 0),
    ("srv-app-01", "10.0.0.20", "00:1A:2B:3C:4D:14",
     "Server", "Dell", "PowerEdge R750", "Server Room", "online", 0),
    ("srv-db-01", "10.0.0.21", "00:1A:2B:3C:4D:15",
     "Server", "HP", "ProLiant DL380", "Server Room", "online", 0),
    ("prt-acct-01", "10.0.3.5", "00:1A:2B:3C:4D:30",
     "Printer", "HP", "LaserJet Pro M428", "Accounting", "offline", -3),
    ("ap-wh-01", "10.0.4.10", "00:1A:2B:3C:4D:40",
     "Access Point", "Ubiquiti", "UniFi AP-HD", "Warehouse", "maintenance", -2),
]
...
TASKS = [
    ...
    ("TASK-002", "Deploy new user workstations", "Hardware Setup",
     "Set up 3 desktops for new Accounting hires",
     "Sara Patel", "Accounting", "medium", -3, 4, "pending"),
    ("TASK-003", "Firewall rule audit", "Security",
     "Review and clean up stale firewall rules",
    ...
    ("TASK-006", "Wireless survey floor 3", "Network",
     "Site survey for AP placement on new floor",
     "Sara Patel", "IT", "low", -2, 10, "pending"),
    ("TASK-007", "Onboard new ERP module", "Software Deployment",
     "Install and configure procurement module on app server",
    ...
    ("TASK-010", "SSL certificate renewal", "Security",
     "Renew wildcard cert expiring in 45 days",
     "Sara Patel", "IT", "critical", -1, 30, "in_progress"),
]
