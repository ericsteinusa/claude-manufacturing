            ...
            ('cs_mgr', 'CS Manager Menu', {
                ...
                'items': [
                    ...
                    ('staff_mgmt', 'Staff Management',       {
                        ...
                        'items': [
                            ('staff_sched','Staff Schedule',        'cs_mgr_menu.py'),
                            ('perf_met',   'Performance Metrics',   'cs_mgr_menu.py'),
                            ('staff_train','Staff Training',        'cs_mgr_menu.py'),
                            ('staff_rpts', 'Staff Reports',         'cs_mgr_menu.py'),
                        ],
                    }),
                    ('cust_sat',   'Customer Satisfaction',  {
                        'title': 'Customer Satisfaction',
                        'items': [
                            ('csat_res',   'CSAT Survey Results',   'cs_mgr_menu.py'),
                            ('nps_rpts',   'NPS Reports',           'cs_mgr_menu.py'),
                            ('sat_trends', 'Satisfaction Trends',   'cs_mgr_menu.py'),
                            ('impr_plans', 'Improvement Plans',     'cs_mgr_menu.py'),
                        ],
                    }),
                    ('escalations','Escalations',            {
                        'title': 'Escalations',
                        'items': [
                            ('act_esc',    'Active Escalations',    'cs_mgr_menu.py'),
                            ('esc_hist',   'Escalation History',    'cs_mgr_menu.py'),
                            ('esc_rpts',   'Escalation Reports',    'cs_mgr_menu.py'),
                            ('res_track',  'Resolution Tracking',   'cs_mgr_menu.py'),
                        ],
                    }),
                ],
            }),
