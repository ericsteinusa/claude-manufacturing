...
Usage::
    ...
    python -m manufacturing.seed_sample_marketing            # add (idempotent)
    python -m manufacturing.seed_sample_marketing --reset     # remove + re-add
    python -m manufacturing.seed_sample_marketing --remove    # remove only
"""
