...
_IT_TECH = {
    ...
    'items': [
        ...
        ('help_desk', 'Help Desk Tickets', {
            ...
            'items': [
                ('new_ticket', 'New Ticket', 'it/IT_Tasks.py'),
                ('open_tick', 'Open Tickets', 'it/IT_Tasks.py'),
                ('my_tickets', 'My Assigned Tickets', 'it/IT_Tasks.py'),
                ('tick_hist', 'Ticket History', 'it/IT_Tasks.py'),
            ],
        }),
        ('asset_mgmt', 'Asset Management', {
            'title': 'Asset Management',
            'items': [
                ('asset_inv', 'Asset Inventory', 'it/IT_Tasks.py'),
                ('new_asset', 'New Asset', 'it/IT_Tasks.py'),
                ('asset_hist', 'Asset History', 'it/IT_Tasks.py'),
                ('disposition', 'Disposition', 'it/IT_Tasks.py'),
            ],
        }),
        ('net_status', 'Network Status', {
            'title': 'Network Status',
            'items': [
                ('net_dash', 'Network Dashboard', 'it/IT_Tasks.py'),
                ('bw_monitor', 'Bandwidth Monitor', 'it/IT_Tasks.py'),
                ('net_map', 'Network Map', 'it/IT_Tasks.py'),
                ('inc_log', 'Incident Log', 'it/IT_Tasks.py'),
            ],
        }),
        ('sw_install', 'Software Installations', {
            'title': 'Software Installations',
            'items': [
                ('pend_inst', 'Pending Installs', 'it/IT_Tasks.py'),
                ('sw_inv', 'Software Inventory', 'it/IT_Tasks.py'),
                ('lic_mgmt', 'License Management', 'it/IT_Tasks.py'),
                ('inst_hist', 'Installation History', 'it/IT_Tasks.py'),
            ],
        }),
        ('hw_repairs', 'Hardware Repairs', {
            'title': 'Hardware Repairs',
            'items': [
                ('new_repair', 'New Repair Request', 'it/IT_Tasks.py'),
                ('inprog', 'In Progress', 'it/IT_Tasks.py'),
                ('comp_rep', 'Completed Repairs', 'it/IT_Tasks.py'),
                ('rep_hist', 'Repair History', 'it/IT_Tasks.py'),
            ],
        }),
        ('user_accts', 'User Account Management', {
            'title': 'User Account Management',
            'items': [
                ('create_acct', 'Create Account', 'it/IT_Tasks.py'),
                ('reset_pw', 'Reset Password', 'it/IT_Tasks.py'),
                ('acct_stat', 'Account Status', 'it/IT_Tasks.py'),
                ('acct_audit', 'Account Audit', 'it/IT_Tasks.py'),
            ],
        }),
    ],
}
