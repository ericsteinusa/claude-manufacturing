...
BUTTONS = [
    ("Purchasing Manager", "Purchasing_Mgr_menu.py"),
    ("Purchasing",         "Purchasing_menu.py"),
]
...
class PurchasingMainMenu(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Purchasing Main Menu")
        self.resize(700, 340)
    ...
    def _build_ui(self):
        ...
        title = QtWidgets.QLabel("Purchasing Main Menu")
