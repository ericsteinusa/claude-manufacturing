...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.IT_Calls_Button.setGeometry(QtCore.QRect(20, 20, 221, 41))
        font = QtGui.QFont()
...
"background-color: white; /* Fallback color */")
    ...
    def press_it(self, pressed):
        if pressed == "IT Technician":
            subprocess.Popen(["python3", "IT_technician.py"])

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "IT Manager Menu"))
        self.IT_Calls_Button.setText(_translate("MainWindow", "IT Technician"))
