...
Usage::
    ...
    python -m manufacturing.seeds.seed_sample_accounting            # add (idempotent)
    python -m manufacturing.seeds.seed_sample_accounting --reset     # remove + re-add
    python -m manufacturing.seeds.seed_sample_accounting --remove    # remove only
"""
