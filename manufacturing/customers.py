...
class CustomerDetailPanel(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.v_company  = val(); self.v_name    = val()
        self.v_email    = val(); self.v_phone   = val()
        self.v_address  = val(); self.v_orders  = val()

        layout.addWidget(lbl("Company:"),  0, 0); layout.addWidget(self.v_company, 0, 1)
        layout.addWidget(lbl("Contact:"),  0, 2); layout.addWidget(self.v_name,    0, 3)
        ...
        layout.addWidget(lbl("Orders:"),   3, 0); layout.addWidget(self.v_orders,  3, 1)
