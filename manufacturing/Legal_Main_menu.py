...
class LegalMainMenu(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        tabs.addTab(_placeholder_tab("Contracts"), "Contracts")
        tabs.addTab(_placeholder_tab("Compliance"), "Compliance")
        tabs.addTab(_placeholder_tab("Litigation"), "Litigation")
        tabs.addTab(_placeholder_tab("Intellectual Property"), "Intellectual Property")
        tabs.addTab(_placeholder_tab("Employment Law"), "Employment Law")
        v.addWidget(tabs)
