...
Usage::
    ...
    python -m manufacturing.seed_sample_customers            # add (idempotent)
    python -m manufacturing.seed_sample_customers --reset    # remove + re-add
    python -m manufacturing.seed_sample_customers --remove   # remove only
"""
