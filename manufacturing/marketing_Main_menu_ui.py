...
class Ui_Marketing_Main_Menu(object):
    def setupUi(self, Marketing_Main_Menu):
        if not Marketing_Main_Menu.objectName():
            Marketing_Main_Menu.setObjectName(u"Marketing_Main_Menu")
        ...
        self.centralwidget = QWidget(Marketing_Main_Menu)
        self.centralwidget.setObjectName(u"centralwidget")
        self.market_Mgr_Button = QPushButton(self.centralwidget)
        self.market_Mgr_Button.setObjectName(u"market_Mgr_Button")
        self.market_Mgr_Button.setGeometry(QRect(20, 20, 191, 41))
        font = QFont()
...
"background-color: white; /* Fallback color */")
        ...
        self.menubar = QMenuBar(Marketing_Main_Menu)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 800, 21))
        Marketing_Main_Menu.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(Marketing_Main_Menu)
        self.statusbar.setObjectName(u"statusbar")
        Marketing_Main_Menu.setStatusBar(self.statusbar)

        self.retranslateUi(Marketing_Main_Menu)

        QMetaObject.connectSlotsByName(Marketing_Main_Menu)
    # setupUi

    def retranslateUi(self, Marketing_Main_Menu):
        Marketing_Main_Menu.setWindowTitle(QCoreApplication.translate("Marketing_Main_Menu", u"MainWindow", None))
        self.market_Mgr_Button.setText(QCoreApplication.translate("Marketing_Main_Menu", u"Marketing Manager", None))
