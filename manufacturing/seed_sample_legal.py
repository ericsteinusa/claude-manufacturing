...
CONTRACTS = [
    ...
    (f"{TAG}Office Lease — Main Plant",
     "Realty Group LLC", "Lease", 204000, -730, 365, "Active", "Sandra Pierce"),
    (f"{TAG}Software License — ERP System",
     "TechCorp ERP", "Licensing", 28500, -365, 0, "Active", "Janet Flores"),
    (f"{TAG}NDA — Summit Fabricators",
     "Summit Fabricators", "NDA", 0, -30, 335, "Active", "Sandra Pierce"),
    (f"{TAG}Vendor Agreement — Metal Fab Co.",
     "Metal Fab Co.", "Vendor", 0, -180, 185, "Active", "Janet Flores"),
    (f"{TAG}NDA — Pacific Rim Parts",
     "Pacific Rim Parts", "NDA", 0, -10, 355, "Active", "Sandra Pierce"),
    ...
    (f"{TAG}Confidentiality — Inova Systems",
     "Inova Systems", "NDA", 0, -5, 360, "Active", "Sandra Pierce"),
]
...
COMPLIANCE = [
    ...
    ("OSHA 1910.147 Lockout/Tagout Annual Training",
     "OSHA 29 CFR 1910.147", "Janet Flores", 30, None, "Pending"),
    ("EPA Tier II Hazardous Chemical Reporting",
     "EPA EPCRA Sec. 312", "Sandra Pierce", 60, None, "In Progress"),
    ("GDPR Data Processing Agreement Review",
     "GDPR Article 28", "Janet Flores", 45, None, "In Progress"),
    ("Annual ITAR Compliance Self-Assessment",
     "22 CFR Part 120-130", "Sandra Pierce", 90, None, "Pending"),
    ("Workers Comp Insurance Renewal",
     "State Labor Code", "Janet Flores", 30, None, "Pending"),
    ("ISO 9001 Certificate Renewal",
     "ISO 9001:2015", "Sandra Pierce", 180, None, "Pending"),
    ("ADA Website Accessibility Audit",
     "ADA Title III", "Janet Flores", 60, None, "Pending"),
    ("OSHA 300 Log Annual Summary Posting",
     "OSHA 29 CFR 1904.32", "Sandra Pierce", -30, -28, "Complete"),
    ("PCI-DSS Payment Card Security Review",
     "PCI-DSS v4.0", "Janet Flores", -60, -55, "Complete"),
    ("State Sales Tax Nexus Review",
     "State Rev. Code", "Sandra Pierce", -15, -10, "Complete"),
    ("Export Control Classification Review — New Parts",
     "EAR 15 CFR Part 730", "Janet Flores", 14, None, "In Progress"),
    ("Annual Employee Handbook Update",
     "State Employment Law", "Sandra Pierce", 120, None, "Pending"),
]
...
LITIGATION = [
    ...
    (f"{TAG}Smith v. Company — Slip & Fall",
     "Robert Smith", "Ohio Court of Common Pleas", "Civil", -365,
     "Settled", "Settlement — $18,500 paid; no admission of liability"),
    (f"{TAG}Patent Dispute — Valve Design",
     "ValveTech Industries", "Federal District Court N.D.", "IP", -180,
     "In Discovery", "Discovery phase ongoing; hearing scheduled Q4"),
    (f"{TAG}Breach of Contract — Delta Components",
     "Delta Components Co.", "Ohio Court of Common Pleas", "Contract Dispute", -90,
     "Open", ""),
    (f"{TAG}Employment Claim — Former Employee",
     "Mark Jennings", "EEOC / Mediation", "Employment", -45,
     "Dismissed", "EEOC dismissed claim; no probable cause found"),
    (f"{TAG}Regulatory Notice — EPA",
     "U.S. EPA", "Administrative", "Regulatory", -30,
     "Open", "Response to EPA information request — in progress"),
]
