...
Usage::
    ...
    python -m manufacturing.seed_sample_engineering            # add (idempotent)
    python -m manufacturing.seed_sample_engineering --reset     # remove + re-add
    python -m manufacturing.seed_sample_engineering --remove    # remove only
"""
