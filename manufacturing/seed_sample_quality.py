...
Usage::
    ...
    python -m manufacturing.seed_sample_quality            # add (idempotent)
    python -m manufacturing.seed_sample_quality --reset     # remove + re-add
    python -m manufacturing.seed_sample_quality --remove    # remove only
"""
