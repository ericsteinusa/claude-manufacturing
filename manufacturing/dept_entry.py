...
class DeptEntry(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Department Entry")
        self.resize(600, 500)
    ...
    def _build_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Department Name", "ID"])
    ...
    QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        ...
        # ── Entry form ─────────────────────────────────────────────────────
        form_group = QtWidgets.QGroupBox("Department Record")
        ...
        name_lbl = QtWidgets.QLabel("Department Name:")
