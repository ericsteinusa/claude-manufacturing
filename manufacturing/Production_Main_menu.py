...
class ProductionMainMenu(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Production Main Menu")
    ...
    def _build_ui(self):
        ...
        tabs.addTab(_launch_tab("prod_mgr_Menu.py", "Production Manager"), "Production Manager")
        tabs.addTab(_launch_tab("prod_prod_menu.py", "Production"), "Production")
