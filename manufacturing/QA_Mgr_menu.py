...
"background-color: white; /* Fallback color */")
        ...
        self.QA_Button.setGeometry(QtCore.QRect(20, 10, 191, 41))
        font = QtGui.QFont()
...
"}")
        ...
        QtCore.QMetaObject.connectSlotsByName(QA_mgr_menu)

    def press_it(self, pressed):
        if pressed == "Quality Assurance Menu":
            subprocess.run(["python", "Quality_Assurance_Menu.py"])    

    def retranslateUi(self, QA_mgr_menu):
        _translate = QtCore.QCoreApplication.translate
        QA_mgr_menu.setWindowTitle(_translate("QA_mgr_menu", "QA Manager Menu"))
        self.QA_Button.setText(_translate("QA_mgr_menu", "Quality Assurance"))
