...
################################################################################
## Form generated from reading UI file 'Sales_Main_menu.ui'
##
...
"background-color: white; /* Fallback color */")
        self.Sales_mgr_Button = QPushButton(self.centralwidget)
        self.Sales_mgr_Button.setObjectName(u"Sales_mgr_Button")
        self.Sales_mgr_Button.setGeometry(QRect(20, 10, 221, 41))
        font = QFont()
        font.setPointSize(16)
        self.Sales_mgr_Button.setFont(font)
        self.Sales_mgr_Button.setStyleSheet(u"QPushButton{background-color: white;\n"
...
"}")
        ...
        self.Sales_Button.setGeometry(QRect(270, 10, 151, 41))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText("")
        self.Sales_mgr_Button.setText(QCoreApplication.translate("MainWindow", u"Sales Manager", None))
