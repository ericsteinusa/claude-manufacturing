...
class Ui_Sales_mgr_menu(object):
    def setupUi(self, Sales_mgr_menu):
        if not Sales_mgr_menu.objectName():
            Sales_mgr_menu.setObjectName(u"Sales_mgr_menu")
        ...
        self.centralwidget = QWidget(Sales_mgr_menu)
...
"}")
        ...
        self.statusbar = QStatusBar(Sales_mgr_menu)
        self.statusbar.setObjectName(u"statusbar")
        Sales_mgr_menu.setStatusBar(self.statusbar)

        self.retranslateUi(Sales_mgr_menu)

        QMetaObject.connectSlotsByName(Sales_mgr_menu)
    # setupUi

    def retranslateUi(self, Sales_mgr_menu):
        Sales_mgr_menu.setWindowTitle(QCoreApplication.translate("Sales_mgr_menu", u"MainWindow", None))
        self.label.setText("")
