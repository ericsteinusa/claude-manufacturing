...
@require_http_methods(['GET'])
@api_required
def api_sales_dashboard(request):
    conn = get_db_connection()
    try:
        data = reports_core.sales_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
...
@require_http_methods(['GET'])
@api_required
def api_personnel_dashboard(request):
    conn = get_db_connection()
    try:
        data = personnel_core.get_personnel_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
...
@require_http_methods(['GET'])
@api_required
def api_accounting_dashboard(request):
    conn = get_db_connection()
    try:
        data = reports_core.accounting_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
...
@require_http_methods(['GET'])
@api_required
def api_customer_service_dashboard(request):
    conn = get_db_connection()
    try:
        data = reports_core.customer_service_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
...
@require_http_methods(['GET'])
@api_required
def api_engineering_dashboard(request):
    conn = get_db_connection()
    try:
        data = reports_core.engineering_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
...
@require_http_methods(['GET'])
@api_required
def api_legal_dashboard(request):
    conn = get_db_connection()
    try:
...
@require_http_methods(['GET'])
@api_required
def api_payroll_dashboard(request):
    conn = get_db_connection()
    try:
        data = reports_core.payroll_dashboard(conn)
    finally:
        conn.close()
    return api_ok(data)
