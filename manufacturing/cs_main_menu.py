...
class Ui_Cust_Serv_Main_Menu(object):
    def setupUi(self, Cust_Serv_Main_Menu):
        Cust_Serv_Main_Menu.setObjectName("Cust_Serv_Main_Menu")
...
"}")
        ...
        self.cust_serv_Button.raise_()
        Cust_Serv_Main_Menu.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Cust_Serv_Main_Menu)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 21))
        self.menubar.setObjectName("menubar")
        Cust_Serv_Main_Menu.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Cust_Serv_Main_Menu)
        self.statusbar.setObjectName("statusbar")
        Cust_Serv_Main_Menu.setStatusBar(self.statusbar)

        self.retranslateUi(Cust_Serv_Main_Menu)
        QtCore.QMetaObject.connectSlotsByName(Cust_Serv_Main_Menu)

    def press_it(self, pressed):
        if pressed == "CS Manager Menu":
                subprocess.Popen(["python3", "cs_mgr_menu.py"])
    ...
    def retranslateUi(self, Cust_Serv_Main_Menu):
        ...
        Cust_Serv_Main_Menu.setWindowTitle(_translate("Cust_Serv_Main_Menu", "Customer Service Main Menu"))
        self.cs_mgr_Button.setText(_translate("Cust_Serv_Main_Menu", "CS Manager Menu"))
        self.cust_calls_Button.setText(_translate("Cust_Serv_Main_Menu", "Customer Calls"))
        self.cust_serv_Button.setText(_translate("Cust_Serv_Main_Menu", "Customer Service Menu"))
...
if __name__ == "__main__":
    ...
    ui.setupUi(Cust_Serv_Main_Menu)
    Cust_Serv_Main_Menu.show()
    sys.exit(app.exec())
