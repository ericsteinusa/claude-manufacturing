...
**Menu:** Contracts, Compliance, Litigation, Intellectual Property,
Employment Law. Managers also see a **Legal Manager** menu with Contract
...
Create or edit a legal contract: title, counterparty, type, value, start/end
date, owner, status, notes. Exportable.

## Compliance (`/legal/compliance/`)

Create or edit a compliance requirement (requirement text, regulation,
owner, due date, status) and mark it completed.
